...
function Validation01() {
    ...
    let z = document.getElementById("Email1").value;
    ...
    if (r == true) {
        ...
        document.getElementById("Email1").innerHTML = "Please Enter Correct Email Address";
        return false;
    }
    

    //let ab = document.getElementById("Age").value;

    //if (ab < 18 || ab > 50) {
    //    document.getElementById("Age").innerHTML = "Age must be in between 18 and 50";
    //    return false;
    //}
    //else {
    //    return true;
